package com.example.utktravel.auth;

import com.example.utktravel.config.JwtService;
...
import com.example.utktravel.entities.Role;
import com.example.utktravel.entities.User;
import com.example.utktravel.exceptions.UserAlreadyExistsException;
...
public class AuthenticationService {
    ...
    private void sendVerificationEmail(User user) {
        String verificationUrl = "http://localhost:8080/utktravel/auth/activate?token=" + user.getActivationToken();
        emailService.sendVerificationEmail(user.getEmail(), "Email Verification", buildEmail(user.getUsername(), verificationUrl));
    }
